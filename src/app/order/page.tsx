                ...
                <div className={`w-10/12 space-y-3`}>
                  ...
                  <div className="flex flex-col ">
                    ...
                    <div className="flex justify-between mt-2">
                      <span className="text-sm font-[500]">Delivery cost:</span>
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <span className="font-extrabold text-sm">${totalAmount}</span>
                    </div>
                  </div>
                </div>
                <div className="w-full mt-2">
                  <CheckoutBtn name="Purchase" />
                </div>
              </div>
            </div>
          </Container>
